...
curl -sS "${BASE_URL}/api/lark/contact/users/ou_xxx?userIdType=open_id&departmentIdType=open_department_id&appKey=default"
...
curl -sS "${BASE_URL}/api/lark/contact/users?appKey=default&departmentId=0&pageSize=20&userIdType=open_id&departmentIdType=open_department_id"
...
curl -sS -X POST "${BASE_URL}/api/lark/contact/users?appKey=default&userIdType=open_id&departmentIdType=open_department_id" \
  -H 'Content-Type: application/json' \
...
curl -sS -X PUT "${BASE_URL}/api/lark/contact/users/ou_xxx?appKey=default&userIdType=open_id&departmentIdType=open_department_id" \
  -H 'Content-Type: application/json' \
  -d '{"name":"测试用户A-已更新"}'
...
curl -sS -X DELETE "${BASE_URL}/api/lark/contact/users/ou_xxx?appKey=default&userIdType=open_id"
...
curl -sS "${BASE_URL}/api/lark/contact/departments?appKey=default&parentDepartmentId=0&fetchChild=false&pageSize=20&userIdType=open_id&departmentIdType=open_department_id"

# --- GET /api/lark/contact/departments/{departmentId} ---
# 功能：按部门 ID 查询部门详情。
# 参数（path）：departmentId（与 departmentIdType 一致）。
# 参数（query）：appKey；userIdType 默认 open_id；departmentIdType 默认 open_department_id。
curl -sS "${BASE_URL}/api/lark/contact/departments/od-xxxxxxxx?appKey=default&userIdType=open_id&departmentIdType=open_department_id"
...
curl -sS -X POST "${BASE_URL}/api/lark/contact/departments?appKey=default&userIdType=open_id&departmentIdType=open_department_id" \
  -H 'Content-Type: application/json' \
...
curl -sS -X PUT "${BASE_URL}/api/lark/contact/departments/od-xxxxxxxx?appKey=default&userIdType=open_id&departmentIdType=open_department_id" \
  -H 'Content-Type: application/json' \
  -d '{"name":"测试部门A-已更新"}'
